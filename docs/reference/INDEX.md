...
| Frontend | [frontend.md](frontend.md) | React 19 SPA 구조, TanStack Query 훅·폴링 상수, AI 스트리밍 훅과 SSE 프로토콜 소비(자유 질의 포함), 한글·초성 종목 검색, 브라우저 전용 사용자 상태(관심 종목·알림·패널 접힘 스토어), 차트 지표 계산, ApiError 분기, 빌드/배포 경로 |
