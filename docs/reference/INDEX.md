...
현행 기준은 React Router 7.18.3 및 2026-09-13 운영 반영이다. 전체 탐색은 [문서 안내](../README.md), 변경 요약은 [품질 개선 기록](../quality-upgrade-2026-09-13.md), 운영 증거는 [배포 기록](../deployments/2026-09-13-router7-quality-upgrade.md)을 참조한다.
...
| Frontend | [frontend.md](frontend.md) | React 19·Router 7.18.3 SPA, URL 시장 선택, 시세 필터·CSV·밀도, 취소 가능한 GET·양 시장 폴링·전 화면 알림, 한글·IME 검색, 기사 입력·AI SSE, 브라우저 상태, PWA, strict 타입·Playwright 검증 |
